...
import { QuizMetaInfoMap, SolutionData } from '../types'
...
export class AnkiButton extends LitElement {
  ...
  @property({ type: Object })
  quizMetaMap: QuizMetaInfoMap | undefined
  ...
  private async handleClick() {
    ...
    console.log('quizMetaMap', this.quizMetaMap, data)
    const form = {
      ...
      fields: {
        ...
        SuccessRate: Math.round(this.quizMetaMap![data.globalId].correctRatio).toString(),
    ...
    const addResult = await requestAnki('addNote', { 'note': form })
    console.log('addResult', addResult)
    await requestAnki('addNote', { 'note': form })
  }
